...
export const getResourcesCollection = getCollection(COLLECTION_NAMES.resources) as () => Promise<
  CivicosCollectionMap["resources"]
>;
export const getRequestsCollection = getCollection(COLLECTION_NAMES.requests) as () => Promise<
  CivicosCollectionMap["requests"]
>;
export const getBookingsCollection = getCollection(COLLECTION_NAMES.bookings) as () => Promise<
  CivicosCollectionMap["bookings"]
>;
export const getLedgerCollection = getCollection(COLLECTION_NAMES.ledger) as () => Promise<
  CivicosCollectionMap["ledger"]
>;
export const getInsightsCollection = getCollection(COLLECTION_NAMES.insights) as () => Promise<
  CivicosCollectionMap["insights"]
>;
export const getUsersCollection = getCollection(COLLECTION_NAMES.users) as () => Promise<
  CivicosCollectionMap["users"]
>;
export const getHistoricalMetricsCollection = getCollection(
  COLLECTION_NAMES.historicalMetrics,
) as () => Promise<CivicosCollectionMap["historicalMetrics"]>;
...
export async function getCollections(): Promise<CivicosCollectionMap> {
  ...
  const collections = {
    ...
    historicalMetrics: database.collection(COLLECTION_NAMES.historicalMetrics),
  };
