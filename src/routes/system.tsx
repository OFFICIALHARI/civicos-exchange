...
function SystemValidation() {
  ...
  return (
    <AppShell>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          ...
          <CardHeader
            title={
              <span className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-primary" /> Integrity Check
              </span>
            }
        ...
        <Card>
          <CardHeader
            title={
              <span className="flex items-center gap-2">
                <Database className="h-4 w-4 text-muted-foreground" /> Data Management
              </span>
            }
      ...
      <h2 className="mt-8 mb-3 text-xs font-medium uppercase tracking-[0.14em] text-muted-foreground">
        Test Scenarios
      </h2>
...
function ScenarioCard({ title, description, expected, icon, onClick, loading }: ScenarioCardProps) {
  return (
    <button
      onClick={onClick}
      disabled={loading}
